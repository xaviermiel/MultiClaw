export const AgentVaultFactoryAbi = [
  {
    ...
    inputs: [
      ...
      { name: "_presetRegistry", type: "address", internalType: "address" },
    ],
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: "", type: "address", internalType: "contract PresetRegistry" },
    ],
    stateMutability: "view",
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: "", type: "address", internalType: "contract IModuleRegistry" },
    ],
    stateMutability: "view",
  },
  {
